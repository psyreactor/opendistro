...
your Ruby, Opendistro client and Opendistro instance versions. Please provide steps to
...
#
# @example
#   Opendistro.user('peter')
#   Opendistro.user('opendistro')
#
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/opendistro
   # Navigate to the newly cloned directory
   cd opendistro
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/psyreactor/opendistro
   ```
